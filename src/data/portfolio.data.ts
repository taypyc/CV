...
export const portfolio: IPortfolioData[] = [
    {
        ...
        icon : '',
        description : `Researching Progressive Web Application (PWA) technologies stack.
        Setting up server environment for running application. Setting up Magento Backend and Magento 
        PWA Studio, creating GraphQL queries to obtain  data from the backend side and rendering data on 
        the frontend side, creating new custom PWA components on-demand to meet the client's needs for 
        final product. Maintaining product stability after release on production server.`,
        stack : 'Headless Magento, Magento PWA Studio, React, GraphQL, Apollo Server',
    },
    {
        name : 'E-suvenir',
    ...
    },
    {
        ...
        href : 'NDA',
        icon : '',
        description : `The engagement game similar to classic epic game about Mario Brothers, overcoming obstacles.
        The client starts game to  collect all the game coins, and then he will be able to spend collected 
        coins for shopping in e-store.`,
        stack : 'PhaserJS engine, TypeScript',
    },
    {
        name : 'NDA',
        href : 'NDA',
        icon : '',
        description : `Working with UI/UX designer to create layouts for full-featured photo gallery 
        with ability for customer to add, edit, remove, share their own photos with anyone and save all the history of 
        photo.`,
        stack : 'AngularJS, Gitlab Ci/CD',
    },
    {
        name : 'Liga.net',
        href : 'https://liga.net',
        icon : '',
        description : `Working as a Full-Stack Developer. The biggest and oldest news portal. As a developer 
        I have  redesigned a whole portal ( consists of 6 sites ) from table layout adapted for old browsers 
        to modern ones, using modern approach in mark-up with flex and grid blocks`,
    ...
    },
    {
        ...
        description : `About G.A. Precision - Professional Quality Rifles and Equipment. As a developer 
        I have developed new theme from scratch based on Magento Luma theme and styled additional third-party 
        Magento modules. Made custom Javascript layout for checkout page.`,
        stack : 'Magento, Grunt, jQuery, knockoutJS, less, requireJS, mysql, elasticsearch',
    },
    {
        name : 'Arvi',
        href : 'https://www.arvi.ch/',
        icon : '',
        description : `About project: The Swiss vault of fine and rare Wines. Team I worked with consisted of 10 
        team members (2 FE, 3 BE, 3 QA, 1 PM, 1 BA). The most challengeable project for me as I have developed 
        a lot of custom project-specified modules that allow end customers to collect all their bought wines in the 
        cellars and then customer can consume wine from a tube and save wine state in the customer account dashboard.`,
    ...
    },
    {
        ...
        description : `Kmiyat platform is designed to be the largest platform in the Arab world for wholesale 
        low-cost  and focuses on providing all services that help wholesalers to reach more customers and raise 
        sales volumes, in addition to reducing the costs of business operations with buyers and not take any 
        ratios or amounts on direct sales between Traders and buyers. I have developed the entire front-end 
        part of the project inclusively with an Arabic version.`,
        stack : 'Magento, Magento CLI, Grunt, jQuery, knockoutJS, less, requireJS, mysql, elasticsearch',
    },
    {
